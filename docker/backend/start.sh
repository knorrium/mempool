...
__MEMPOOL_HTTP_PORT__=${BACKEND_HTTP_PORT:=8999} #TODO: Update this to MEMPOOL_HTTP_PORT
...
__MAXMIND_GEOLITE2_CITY__=${MAXMIND_GEOLITE2_CITY:=""}
__MAXMIND_GEOLITE2_ASN__=${MAXMIND_GEOLITE2_ASN:=""}
